...
#Load the all environment variables 
load_dotenv()
...
Write_task = Task(
    ...
    """,
    expected_output="A well-structured markdown article of 5-8 paragraphs with clear sections and engaging content",
    agent=News_Writer,
    output_file='article_blog.md',
...
st.markdown("""
This application uses CrewAI with Gemini to generate comprehensive articles on any topic. 
